...
public class Credit extends Vente{
    ...
    public Credit( Date date, Personne client, ArrayList<Piece> piece_vendu, double prix_totale, double somme_remb,double montant) {
        super( date, client, piece_vendu,montant);
